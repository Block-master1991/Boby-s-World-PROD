...
function generateGrassData(chunkX: number, chunkZ: number, options: GrassOptions) {
    const positions = [];
    const scales = [];
    const quaternions = [];
    const colors = [];
...
function generateRockData(chunkX: number, chunkZ: number, options: RocksOptions): { positions: number[]; scales: number[]; quaternions: number[]; colors: number[] } {
    const positions = [];
    const scales = [];
    const quaternions = [];
    const colors = [];
...
function generateTreeData(chunkX: number, chunkZ: number, options: TreesOptions): { positions: number[]; scales: number[]; quaternions: number[]; colors: number[] } {
    const positions = [];
    const scales = [];
    const quaternions = [];
    const colors = [];
...
function generateFlowerData(chunkX: number, chunkZ: number, options: FlowerOptions): { positions: number[]; scales: number[]; quaternions: number[]; colors: number[] } {
...
self.onmessage = (e) => {
    ...
    const { chunkX, chunkZ, grassOptions, rocksOptions, treesOptions, flowersOptions, chunkKey } = e.data;
    ...
    // Generate chunk data
    const grassData = generateGrassData(chunkX, chunkZ, grassOptions);
    const rocksData = generateRockData(chunkX, chunkZ, rocksOptions);
    const treesData = generateTreeData(chunkX, chunkZ, treesOptions);
    const flowersData = generateFlowerData(chunkX, chunkZ, flowersOptions);
