    ...
    <Card className="w-full shadow-md bg-background/80 backdrop-blur-sm">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">
          ...
          or <span className="font-semibold">Arrow Keys</span> to move on desktop.
        </p>
        <p className="text-sm text-muted-foreground mt-1">
          ...
          while moving to sprint.
        </p>
        <p className="text-sm text-muted-foreground mt-1">On mobile, use the on-screen joystick.</p>
      </CardContent>
    </Card>
  );
};
