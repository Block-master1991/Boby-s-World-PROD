...
interface TooltipLabelProps {
  ...
  labelFormatter?:
    | ((v: string | number | React.ReactNode, p: ChartTooltipPayload[]) => React.ReactNode)
    | undefined;
      ...
      >
        {!nestLabel && (
          <TooltipLabel
            ...
            label={label}
            labelKey={labelKey}
            labelFormatter={labelFormatter as TooltipLabelProps["labelFormatter"]}
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  if (key in payload && typeof (payload as Record<string, unknown>)[key] === "string")
    k = (payload as Record<string, unknown>)[key] as string;
