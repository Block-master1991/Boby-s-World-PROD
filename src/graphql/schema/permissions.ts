...
// Rules
const isAuthenticated = rule({ cache: "contextual" })((_parent, _args, context: GraphQLContext) => {
  return context.user !== null;
});

const isAdmin = rule({ cache: "contextual" })((_parent, _args, context: GraphQLContext) => {
