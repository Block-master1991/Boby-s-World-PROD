 ...
 */
export const PROFESSIONAL_DITHER_GLSL = `
...
/**
 * GLSL Simplex Noise 2D and 3D implementations.
...
vec4 permute_4d(vec4 x) { return mod289_4d(((x*34.0)+1.0)*x); }
...
float simplex3d(vec3 v) {
  ...
  vec3 x3 = x0 - D.yyy;
  i = mod289_3d(i);
  vec4 p = permute_4d(permute_4d(permute_4d(i.z + vec4(0.0, i1.z, i2.z, 1.0)) + i.y + vec4(0.0, i1.y, i2.y, 1.0)) + i.x + vec4(0.0, i1.x, i2.x, 1.0));
