...
export const storeItems: StoreItemDefinition[] = [
    { id: '1', name: 'Protection Bottle', description: 'When enemies attack, this Bottle is consumed instead of your coins, protecting your wealth.', price: 0.001, image: '/Boby-logo.png', dataAiHint: 'sturdy Bottle', icon: Droplet },
