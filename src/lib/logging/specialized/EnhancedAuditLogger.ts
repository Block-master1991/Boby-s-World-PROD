...
export class EnhancedAuditLogger {
  ...
  public async logEvent(params: LogEventParams): Promise<void> {
    const { eventType, message, metadata = {}, severity = "info", complianceLevel } = params;
  ...
  public async logLoginFailure(metadata: AuditEventMetadata, reason: string): Promise<void> {
    await this.logEvent({
      ...
      metadata: { ...metadata, errorDetails: reason },
      severity: "warn",
    });
  }
  ...
  public async logSessionViolation(
    ...
    await this.logEvent({
      eventType: "SESSION_VIOLATION",
      message: `Session violation for user ${userId}: ${reason}`,
      metadata: { ...metadata, userId, errorDetails: reason },
      severity: "critical",
    });
  }
  ...
  public async logTransaction(
    ...
    await this.logEvent({
      ...
      metadata: { ...metadata, userId, transactionType: type, amount },
      severity: "info",
  ...
  public async logDataAccess(
    ...
    await this.logEvent({
      ...
      metadata: { ...metadata, userId, resource },
      severity: "info",
  ...
  public async logDataModification(
    ...
    await this.logEvent({
      ...
      message: `User ${userId} modified ${resource}`,
      metadata: { ...metadata, userId, resource },
      severity: "warn",
      complianceLevel: "GDPR",
    });
  ...
  public async logDataDeletion(
    ...
    await this.logEvent({
      ...
      message: `User ${userId} deleted ${resource}`,
      metadata: { ...metadata, userId, resource },
      severity: "warn",
      complianceLevel: "GDPR",
    });
  ...
  public async logAdminAction(
    ...
    await this.logEvent({
      ...
      metadata: { ...metadata, adminId, action, target },
      severity: "warn",
      complianceLevel: "SOC2",
    });
  }
