...
export const useGameSystems = ({
  ...
  const coins = useCoinLogic({
    ...
    isPausedRef,
    octreeRef,
    addFloatingEffect: floatingEffects.addFloatingEffect,
  });
  const enemies = useEnemyLogic({
    sceneRef,
    dogModelRef,
    isShieldActiveRef,
    protectionBottleCountRef,
    ...
    onEnemyCollisionPenalty,
    isPausedRef,
    coinMeshesRef: coins.coinMeshesRef,
    loadedCoinChunks: coins.loadedCoinChunks,
    onCoinCollected,
