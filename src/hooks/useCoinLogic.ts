...
const clearCoins = (scene: THREE.Scene, coinMeshes: CoinData[], octree: Octree<GameObject> | null) => {
...
export const useCoinLogic = (props: UseCoinLogicProps) => {
    ...
    const updateCoins = useCallback(() => {
        ...
        manageChunks(props.dogModelRef.current.position, currentDogChunk, loadedCoinChunks, { load: loadCoinsForChunk, unload: unloadCoinsFromChunk });
        updateCoinPhysics();
    }, [props.isPausedRef, props.dogModelRef, loadedCoinChunks, loadCoinsForChunk, unloadCoinsFromChunk, updateCoinPhysics]);
