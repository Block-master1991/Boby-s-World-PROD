...
import { useAdminRouting } from "@/hooks/admin/useAdminRouting";
...
export default function AdminPage() {
  ...
  if (!isAuthenticated || !isAdmin)
    return <AdminAccessDeniedScreen isAuthenticated={isAuthenticated} />;
  ...
  return (
    <SidebarProvider
      ref={topRef}
      style={
        { "--sidebar-width": "16rem", "--sidebar-width-mobile": "18rem" } as React.CSSProperties
      }
    >
      <AdminSidebar
