            ...
            <div className="w-full max-w-2xl">
                <Card className="border-amber-500/20 shadow-2xl">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            Administrative access requires biometric authentication. Please enroll a passkey to continue.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <React.Suspense fallback={<div className="flex items-center justify-center py-8"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>}>
